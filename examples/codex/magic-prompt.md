...
If that fails, clone https://github.com/jk06095-lang/ux-sentinel.git into /tmp/ux-sentinel or .codex-tools/ux-sentinel, then run npm install && npm run build there and use node <tool-dir>/dist/cli.js.
