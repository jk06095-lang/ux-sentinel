...
- focus and keyboard: `focus_ring_missing`, `focus_obscured_by_author_content`, `focus_order_unexpected_jump`, `focus_caused_context_change`, `keyboard_target_not_reachable`
...
- layout, graph, and pointer traces: `card_overlap`, `card_content_clipped`, `responsive_layout_breakpoint_overlap`, `popover_blocks_primary_action`, `tooltip_blocks_trigger`, `sticky_layer_hides_content`, `edge_label_crosses_node`, `edge_crosses_critical_label`, `selected_path_not_traceable`, `graph_control_not_discoverable`, `node_label_truncated`, `text_occluded_by_graph_edge`, `cursor_target_drift`, `target_moved_during_cursor_approach`, `overlay_appeared_during_cursor_approach`
