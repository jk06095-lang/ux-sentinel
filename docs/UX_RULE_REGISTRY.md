...
- feedback and safety: `no_feedback_after_action`, `status_change_not_announced`, `loading_without_progress_or_timeout`, `dead_end_state_without_recovery`, `empty_state_without_next_step`, `destructive_action_without_confirmation`
