...
Skipped actions must keep before/after screenshots, a screen map, and a clear skip reason. The contact sheet also shows the safe-click decision so a reviewer can see what the runner did and what it refused to do.
